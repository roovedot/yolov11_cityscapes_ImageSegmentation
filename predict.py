...
model = YOLO('/media/roovedot/PHILIPS/cityscapes/resultados/train1310/weights/best.pt')

# Path to the input video
video_path = '/media/roovedot/common/Pr.Inv.JavierFernandez/InvProject/testvideo.ts'
# '/media/roovedot/common/Pr.Inv.JavierFernandez/InvProject/testvideo.ts'
# '/media/roovedot/PHILIPS/cityscapes/dashcamsEspaña.mp4'
...
output_path = '/media/roovedot/PHILIPS/cityscapes/resultados/testvideo_best1310.mp4'  # Adjust path as needed
